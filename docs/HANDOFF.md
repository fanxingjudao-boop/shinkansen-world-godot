...
- 演出: Glow=Main の Environment、星きらきら/バースト=`stars.gd`、なかよしハート=`animal.gd._pop_heart`、SL蒸気=`train.gd._attach_steam`、UIバウンス=`touch_hud.gd._add_press_bounce`。Glow の Web での効きは要実機確認。
